...
include_once(dirname(__FILE__).'/../../classes/BeesBlogCategory.php');
include_once(dirname(__FILE__).'/../../classes/BeesBlogPost.php');
include_once(dirname(__FILE__).'/../../classes/BeesBlogImageType.php');
